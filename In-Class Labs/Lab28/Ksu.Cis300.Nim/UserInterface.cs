...
namespace Ksu.Cis300.Nim
{
    ...
    {
        /// <summary>
        /// Store the correct move for each board position evaluated.
        /// </summary>
        private Dictionary<Board, Play> _moves;
        ...
        public UserInterface()
        {
            ...
            Setup();
            _moves = new Dictionary<Board, Play>();
        }
        ...
        {
            Play p;
            if (_moves.TryGetValue(b, out p)) return p;
