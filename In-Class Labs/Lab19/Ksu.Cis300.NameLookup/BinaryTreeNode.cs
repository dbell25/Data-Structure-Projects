...
namespace Ksu.Cis300.ImmutableBinaryTrees
{
    ...
    {
        /// <summary>
        /// Stores the height of the AVL tree.
        /// </summary>
        private int _height;
        ...
        private BinaryTreeNode(T data, BinaryTreeNode<T> left, BinaryTreeNode<T> right)
        {
            ...
            _leftChild = left;
            _rightChild = right;
            _height = 1 + Math.Max(Height(LeftChild), Height(RightChild));
        }
        ...
        {
            BinaryTreeNode<T> newRightChild = new BinaryTreeNode<T>(root, left.RightChild.RightChild, right);
            BinaryTreeNode<T> newLeftChild = new BinaryTreeNode<T>(left.Data, left.LeftChild, left.RightChild.LeftChild);
            return new BinaryTreeNode<T>(left.RightChild.Data, newLeftChild, newRightChild);
        }
        ...
        {
            BinaryTreeNode<T> newLeftChild = new BinaryTreeNode<T>(root, left, right.LeftChild.LeftChild);
            BinaryTreeNode<T> newRightChild = new BinaryTreeNode<T>(right.Data, right.LeftChild.RightChild, right.RightChild);
            return new BinaryTreeNode<T>(right.LeftChild.Data, newLeftChild, newRightChild);
        }
