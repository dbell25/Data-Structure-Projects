...
{ }
    ...
    /// <summary>
    /// A public class that implements IEnumerator.
    /// </summary>
    public class Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
    {
        ...
        /// <summary>
        /// Stores the current LinkedListCell.
        /// </summary>
        private LinkedListCell<KeyValuePair<TKey, TValue>>_cell = new LinkedListCell<KeyValuePair<TKey, TValue>>();
        ...
        public KeyValuePair<TKey, TValue> Current
        {
            get
            {
                if (_index == -1 || _index == _hashtable.Length) throw new InvalidOperationException();
                return _cell.Data;
            }
        }
        ...
        /// <summary>
        /// A public constructor for Enumerator.
        /// </summary>
        /// <param name="table"></param>
        public Enumerator(LinkedListCell<KeyValuePair<TKey, TValue>>[]table)
        {
            _hashtable = table;
        }
        ...
        /// <summary>
        /// Determines wether or not another non-null cell exists.
        /// </summary>
        /// <returns></returns>
        public bool MoveNext()
        {
            if (_index == _hashtable.Length) return false;
            _cell = _cell.Next;
